...
public class EditStudentFrame extends javax.swing.JFrame {
     ...
     */
    public EditStudentFrame(String CIN_Passport) {
        initComponents();
    ...
    private void fetchStudent(){
            ...
            if (resultSet.next()) {
                ...
                FileUploaded.setText(resultSet.getString("photo"));
                savedImageIcon = new javax.swing.ImageIcon(FileUploaded.getText());
