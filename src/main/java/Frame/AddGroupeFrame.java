 ...
 * @author Ahmed
 */
public class AddGroupeFrame extends javax.swing.JFrame {

    Groupe G;

    /**
     * Creates new form AddGroupeFrame
     */
    ...
    private void SaveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveBtnActionPerformed
        ...
        G.ajouter(IdCIn, NomGRPIn, NumGRPIn, IdCIn);
        this.dispose();
    ...
    public int verifCoordonnees() {
        ...
        int IdCIn = Integer.valueOf(IdC.getText());
        if (IdGRPIn <=0) {
            displayError("Vous devez taper l'identifiant de groupe");
            return -1;
        }
        if (NumGRPIn <= 0) {
        ...
        if (IdCIn <= 0) {
            displayError("Id de la classe doit être strictement positive");
            return -1;
        }
