 ...
 * @author Ahmed
 */
public class AddStageForm extends javax.swing.JFrame {

    Stage S;

    /**
     * Creates new form AddStageForm
     */
    public AddStageForm() {
        S = new Stage();
        initComponents();
    ...
    private void SaveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveButtonActionPerformed
        ...
        int idSIn = Integer.valueOf(idS.getText());
        S.ajouter(idSIn, type, dateDebut, dateFin, IdEIn);
        this.dispose();
    ...
    public int verifCoordonnees() {
        ...
        if (IdEIn.length() == 0) {
            displayError("Identifiant Etudiant invalide");
            return -1;
        }

        if (idSIn <= 0) {
            displayError("Vous devez donner l'identifiant du stage");
            return -1;
        }
        if (type.length() == 0) {
