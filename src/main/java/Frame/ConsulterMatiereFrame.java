...
public class ConsulterMatiereFrame extends javax.swing.JFrame {
 ...
 private Matiere matiere;
    ...
    private void initComponents() {
        ...
        ConsulterEvaluations = new javax.swing.JButton();
        ...
        jLabel1.setText("Consulter une Matiere");
        ...
        ConsulterEvaluations.setBackground(new java.awt.Color(0, 102, 153));
        ConsulterEvaluations.setFont(new java.awt.Font("Inter", 1, 14)); // NOI18N
        ConsulterEvaluations.setForeground(new java.awt.Color(255, 255, 255));
        ConsulterEvaluations.setText("Consulter Evaluations");
        ConsulterEvaluations.setToolTipText("");
        ConsulterEvaluations.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(128, 163, 255)));
        ConsulterEvaluations.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ConsulterEvaluationsActionPerformed(evt);
            }
        });
        kGradientPanel1.add(ConsulterEvaluations);
        ConsulterEvaluations.setBounds(422, 510, 170, 39);
        ...
        coeff_JFIELD1.setEditable(false);
        ...
        vhoraire_JFIELD.setEditable(false);
    ...
    private void ConsulterEvaluationsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConsulterEvaluationsActionPerformed
      
        

    }//GEN-LAST:event_ConsulterEvaluationsActionPerformed
    ...
    private void Supprimer_ROLE1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Supprimer_ROLE1ActionPerformed
           int option = JOptionPane.showOptionDialog(null, "supprimer cette matiere  ?", "Warning",
