 ...
 * @author Ahmed
 */
public class EditEvaluationFrame extends javax.swing.JFrame {

    Evaluation Ev;

    /**
     * Creates new form EditEvaluationFrame
     */
    public EditEvaluationFrame(Evaluation Ev) {
        initComponents();
        this.Ev = Ev;
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Modifier une Évaluation");
    ...
    private void SaveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveBtnActionPerformed
        ...
        Ev.modifier(note);
        Ev.Consulter(Ev.getIdE(), Ev.getIdM(), Ev.getType());
        this.dispose();
