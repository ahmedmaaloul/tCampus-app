...
public class ModifierEnseignantFrame extends javax.swing.JFrame {

    Enseignant enseignant;
    ImageIcon savedImageIcon = new javax.swing.ImageIcon(getClass().getResource("/photo_profile.jpg"));

    public ModifierEnseignantFrame(Enseignant enseignant) {
        initComponents();
        this.enseignant = enseignant;
         cinpassport.setText(enseignant.getCIN_Passport());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Modifier un Enseignant");
    ...
    private void SaveButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveButton1ActionPerformed
        ...
        enseignant.modifier(nomUtilisateur, emailIn, passwordIn, prenomIn, nomIn, telIn, genreIn, photo, dateNaissance,typeln,fonctionln);
        enseignant.consulter(enseignant.getCNSS());
        this.dispose();
