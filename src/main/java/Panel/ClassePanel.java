...
public class ClassePanel extends javax.swing.JPanel {
    ...
    private void fetchClasses(){
            ...
            String query = "SELECT id,nom,specialite,diplome,niveau FROM Classe";

            if (!search.isEmpty()) {

                query += " WHERE nom LIKE '%" + search + "%'    OR specialite LIKE '%" + search + "%' OR diplome LIKE '%" + search + "%' ";
            }
            ...
            while (resultSet.next()) {
                ...
                rowData[2] = resultSet.getString("specialite");
                rowData[3] = resultSet.getString("diplome");
                rowData[4] = resultSet.getString("niveau");
                rowData[5] = "Actions";
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Identifiant", "Nom", "Spécialité", "Diplôme", "Niveau", "Actions"
            }
        ) {
