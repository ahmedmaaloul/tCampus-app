...
private String nom;
    ...
    public ConsulterDepartementFrame(int idDept,String nomDept,int idChefDept) {
        initComponents();
    ...
    private void Modifier_ROLEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Modifier_ROLEActionPerformed
       ModifierDepartementFrame tempFrame=new ModifierDepartementFrame(id,nom,idChefDept);
